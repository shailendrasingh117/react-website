  ...
  return (
    ...
    <footer>
        <div class="footer row flex container">
          <div class="footer-details row">
            <ul>
              ...
              <li class="row">
                <h5>Email:</h5>
                <p>contact@blackdiamond.com</p>
              </li>
            </ul>
            <a href="#" class=""><img src="../Assets/SL-111719-25140-24.jpg" width="230px" height="140px" alt=""/></a>
        </div>
          ...
          <h5>NewsLetter:</h5>
                ...
                <button type="submit" class="page-btn-2">Subscribe</button>
                   </form>
        ...
        <div class="copy-right">
            <div class="container">
              <p>Black Diamond &copy; 2023, All Rights Reserved </p>
            </div>
          </div>
        </footer>
    </div>
